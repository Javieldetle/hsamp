...
$sql = "SELECT r.*, per.nombre, per.apellidos, h.id_habitacion, h.numero AS num_hab, th.nombre AS tipo_hab
        FROM reserva r
...
<tr>
    ...
    <td class="align-middle">
        ...
        <?php else : ?>
            ...
            <br>
            <a href="../procesar_pago.php?id_reserva=<?php echo $res['id_reserva']; ?>&total=<?php echo $diferencia; ?>&from=admin" 
...
<div class="modal fade" id="modalNueva" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl"> <form action="acciones_reserva.php" method="POST" class="modal-content shadow-lg border-0">
    ...
    <div class="col-md-12">
        ...
        <div class="input-group">
            ...
            <input type="text" id="buscar_cliente_input" class="form-control" placeholder="Escriba DNI o Apellidos para buscar...">
